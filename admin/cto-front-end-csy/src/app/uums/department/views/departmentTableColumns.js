...
const type = FilterType.DEPARTMENT;

const {updateRight, deleteRight, addMenuRight, addControllerResourceRight, assignUserRight, unAssignUserRight, findPrivilegeRight} = api.department;
                    ...
                    }
                    {
                        ...
                        <span>
                            <AModal title="修改组织" text="修改">
                                <DepartmentUpdateForm cb={() => {refresh();}} data={record}/>
                            </AModal>
