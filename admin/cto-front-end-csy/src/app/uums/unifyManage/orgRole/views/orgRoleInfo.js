...
const OrgRoleInfo = ({id, type, res, update, showUpdatePage, remove, getData, refreshOrgStructure}) => {
    switch (type) {
                        ...
                        return (<Form>
                            ...
                            <FormItem>
                                <ButtonModal style={{ marginLeft: 8 }} title="分配人员" text="分配人员" width="80%">
                                    <AssignAndUnAssignPerson type={FilterType.ORGROLE} dataId={id} cb={refreshOrgStructure}/>
                                </ButtonModal>
                            </FormItem>
                        </Form>);
                    return (
