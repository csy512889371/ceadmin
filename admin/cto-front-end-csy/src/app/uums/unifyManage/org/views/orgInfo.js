...
const OrgInfo = ({id, type, res, update, showUpdatePage, remove, getData, refreshOrgStructure}) => {
    switch (type) {
                        ...
                        <Form>
                            ...
                            <FormItem>
                                ...
                                <ButtonModal style={{ marginLeft: 8 }} title="分配人员" text="分配人员" width="80%">
                                    <AssignAndUnAssignPerson type={FilterType.ORG} dataId={id} cb={refreshOrgStructure}/>
                                </ButtonModal>
                            </FormItem>
                        </Form>
                    );
