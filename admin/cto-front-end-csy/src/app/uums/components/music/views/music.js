...
import {selectVisibleMusicPage} from '../selector';
import {findMusicForPage} from '../actions';

import SearchBar from '../../custom/searchbar'
import Table from '../../custom/table'
import { FormModal } from '../../custom/modalForm'
...
class Music extends Component {
    ...
    componentDidMount() {
        const {findMusicForPage} = this.props;
        findMusicForPage({  // 默认是热歌版
    ...
    render() {
        ...
        const songArray = [];
        let songList = musicList ? musicList.data : [];
...
const mapStateToProps = state => {
    return {
        musicList: selectVisibleMusicPage(state)
    }
};
const mapDispatchToProps = dispatch => ({
    findMusicForPage: bindActionCreators(findMusicForPage, dispatch)
});
